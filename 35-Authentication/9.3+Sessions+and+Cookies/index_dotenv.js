...
passport.use(new Strategy(async (username1, password, callback) => {
    console.log(`user name_1 grab by strategy = ${username1}`);
    console.log(`password grab by strategy = ${password}`);
    db.query("SELECT * FROM users WHERE email = $1", [username1], (err, result) => {
